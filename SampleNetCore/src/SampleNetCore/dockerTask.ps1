...
.PARAMETER Clean
Removes the image samplenetcore and kills all containers based on that image.
...
Build a Docker image named samplenetcore
#>
...
$imageName="samplenetcore"
$projectName="samplenetcore"
$serviceName="samplenetcore"
